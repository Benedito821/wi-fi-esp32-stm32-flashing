...
function getFileInfo() 
{
    ...
    document.getElementById("file_info").innerHTML = "<h4>File name: " + file.name + "<br>" + "Size: " + file.size + " bytes</h4>";
}
...
{	
    document.getElementById("ota_update_status").innerHTML = "OTA Firmware Update Complete. This page will be refreshed shortly, Rebooting in: " + seconds;
